...
<div class="min-h-screen flex flex-col items-center justify-center bg-green-500">
      ...
      <form action="#">
        ...
        <div class="flex flex-col mb-6">
          <div class="relative">
            ...
            <input id="password" type="password" name="confirm password" class="text-sm sm:text-base rounded-full placeholder-gray-500 pl-10 pr-4 rounded-lg border border-gray-400 w-full py-2 focus:outline-none focus:border-blue-400" placeholder="Confirm Password" />
          </div>
        </div>
